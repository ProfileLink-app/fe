    ...
    return (
        <div className='min-h-screen overflow-hidden bg-white sm:bg-gray-100'>
            ...
            <div className='flex items-center justify-center mx-auto max-w-7xl'>
                <div className='mx-2 right-0 flex flex-col gap-2 p-10 mt-16 bg-white sm:shadow-xl sm:shadow-outline max-w-[550px] w-full sm:drop-shadow-xl rounded-xl transition'>
