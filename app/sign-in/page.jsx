    ...
    return (
        <div className='min-h-screen overflow-hidden bg-gray-100'>
            ...
            <div className='flex items-center justify-center mx-auto max-w-7xl'>
                <div className='mx-2 right-0 flex flex-col gap-2 p-10 mt-16 bg-white shadow-xl shadow-outline max-w-[550px] w-full drop-shadow-xl rounded-xl'>
                    ...
                    <div className='text-sm text-right transition text-secondary hover:text-secondary-hover hover:underline'>Forgot password?</div>
                    <Link href='/profile/edit'>
                        <button className='w-full px-4 py-2 mt-6 text-sm font-medium text-white transition rounded-md bg-primary hover:bg-primary-hover h-min'>Sign In</button>
                    </Link>
                </div>
            </div>
        </div>
